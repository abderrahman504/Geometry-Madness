...
func get_picked_up():
	...
	tween.tween_property(self, "position", player.position, 0.1) # Tween nodes are useful for animating properties in code, here we animate the position of the pick up to the player position
